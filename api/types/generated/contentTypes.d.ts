...
export interface ApiBlockBlock extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u539F\u5B50\u5185\u5BB9\u5757\uFF1A\u4EFB\u4F55\u751F\u6D3B\u5FC3\u5F97\u3001\u56FE\u7247\u3001\u94FE\u63A5\u3002\u4E0D\u5C5E\u4E8E\u4EFB\u4F55\u56FA\u5B9A\u5206\u7C7B\uFF0C\u4EC5\u901A\u8FC7 Connection \u6302\u8F7D\u5230 Channel\u3002';
    displayName: 'Block';
    pluralName: 'blocks';
    singularName: 'block';
  };
  ...
  attributes: {
    blockType: Schema.Attribute.Enumeration<['text', 'image', 'link', 'file']> &
      Schema.Attribute.Required &
    ...
    connectionCount: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    connections: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiChannelChannel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u7B56\u5C55\u5BB9\u5668\u3002\u4E0E Block \u7684\u591A\u5BF9\u591A\u5173\u7CFB\u4E0D\u4F7F\u7528\u88F8 manyToMany\uFF0C\u800C\u662F\u901A\u8FC7 Connection\uFF08\u5173\u8054\u5BF9\u8C61\u6A21\u5F0F\uFF09\u7269\u5316\uFF0C\u4EE5\u643A\u5E26 who/when \u5143\u6570\u636E\u3002';
    displayName: 'Channel';
    pluralName: 'channels';
  ...
  attributes: {
    appearances: Schema.Attribute.Relation<
      'oneToMany',
      'api::connection.connection'
    >;
    channelFollowers: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    collaboratorNames: Schema.Attribute.JSON;
    ...
    followerCount: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visibility: Schema.Attribute.Enumeration<['public', 'closed', 'private']> &
      Schema.Attribute.Required &
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Block \u4E0B\u7684\u8BC4\u8BBA\u3002authorName \u53CD\u89C4\u8303\u5316\uFF08user \u5173\u7CFB API \u4F1A\u88AB sanitize\uFF09\u3002';
    displayName: 'Comment';
    pluralName: 'comments';
...
export interface ApiConnectionConnection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    connector: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    connectorName: Schema.Attribute.String;
    contentChannel: Schema.Attribute.Relation<
      'manyToOne',
      'api::channel.channel'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiNotificationNotification
  ...
  info: {
    description: '\u7AD9\u5185\u901A\u77E5\u3002\u5168\u53CD\u89C4\u8303\u5316\uFF08recipientName/actorName + \u76EE\u6807\u7684\u5C55\u793A\u4E0E\u94FE\u63A5\u5B57\u6BB5\uFF09\uFF0C\u907F\u514D user \u5173\u7CFB sanitize \u4E0E populate\u3002';
  ...
  attributes: {
    ...
    targetBlockId: Schema.Attribute.String;
    targetChannelSlug: Schema.Attribute.String;
    targetChannelTitle: Schema.Attribute.String;
...
export interface ApiWikiPageWikiPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u7BA1\u7406\u5458\u7F16\u6392\u7684 Wiki \u9875\uFF1A\u6811\u72B6\u5C42\u7EA7 + \u6709\u5E8F items\uFF08\u5F15\u7528 Block/Channel \u6216\u7F16\u8F91\u6027\u6587\u5B57\uFF09\u3002';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    curatorName: Schema.Attribute.String;
    ...
    parent: Schema.Attribute.Relation<'manyToOne', 'api::wiki-page.wiki-page'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    collaboratingChannels: Schema.Attribute.Relation<
      'manyToMany',
      'api::channel.channel'
    >;
    ...
    followedChannels: Schema.Attribute.Relation<
      'manyToMany',
      'api::channel.channel'
    >;
    followerCount: Schema.Attribute.Integer &
    ...
    following: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    followingNames: Schema.Attribute.JSON;
